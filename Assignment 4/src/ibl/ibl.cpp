...
AssetManager assets({
    ...
    {   { "model"   , "../resources/objects/cerberus/Cerberus_LP.FBX"  },
        { "transformation"   , glm::scale(glm::mat4(1.0f), glm::vec3(0.01))  },
    //{ TEX_FLIP, true }, // if true, causes textures to be flipped in y
    { "albedo" , "../resources/objects/cerberus/Textures/Cerberus_A.tga" },
    { "normal"  , "../resources/objects/cerberus/Textures/Cerberus_N.tga"},
    { "metallness"  , "../resources/objects/cerberus/Textures/Cerberus_M.tga"},
    { "roughness"  , "../resources/objects/cerberus/Textures/Cerberus_R.tga"},
...
int main()
{
    ...
    // -------------------------
    Shader pbrShader("../src/ibl/pbr.vs", "../src/ibl/pbr.fs");
    Shader equirectangularToCubemapShader("../src/ibl/cubemap.vs", "../src/ibl/equirectangular_to_cubemap.fs");
    Shader irradianceShader("../src/ibl/cubemap.vs", "../src/ibl/irradiance_convolution.fs");
    Shader prefilterShader("../src/ibl/cubemap.vs", "../src/ibl/prefilter.fs");
    Shader brdfShader("../src/ibl/brdf.vs", "../src/ibl/brdf.fs");
    Shader backgroundShader("../src/ibl/background.vs", "../src/ibl/background.fs");
